...
(1, 2, 'Intel Core i3-10100F', 'Intel', 'Core i3-10100F', 'Бюджетный 4-ядерный процессор без встроенной графики', 8500, 65, 1, 'icons/cpu1'),
(2, 2, 'Intel Core i5-10400F', 'Intel', 'Core i5-10400F', 'Сбалансированный 6-ядерный процессор для игр', 13000, 65, 2, 'icons/cpu2'),
(3, 2, 'Intel Core i7-10700K', 'Intel', 'Core i7-10700K', 'Мощный 8-ядерный процессор с разблокированным множителем', 28000, 125, 3, 'icons/cpu3'),
(4, 2, 'Intel Core i9-11900K', 'Intel', 'Core i9-11900K', 'Флагманский процессор 11-го поколения', 42000, 125, 3, 'icons/cpu3'),
(5, 2, 'Intel Core i3-12100F', 'Intel', 'Core i3-12100F', 'Бюджетный процессор 12-го поколения с высокой производительностью на ядро', 9500, 60, 1, 'icons/cpu1'),
(6, 2, 'Intel Core i5-13400F', 'Intel', 'Core i5-13400F', '10-ядерный процессор с гибридной архитектурой', 20000, 65, 2, 'icons/cpu2'),
(7, 2, 'Intel Core i7-13700K', 'Intel', 'Core i7-13700K', '16-ядерный процессор для энтузиастов', 39000, 125, 3, 'icons/cpu3'),
(8, 2, 'Intel Core i9-13900K', 'Intel', 'Core i9-13900K', 'Максимальная производительность для любых задач', 55000, 125, 3, 'icons/cpu3'),
(9, 2, 'AMD Ryzen 3 4100', 'AMD', 'Ryzen 3 4100', 'Бюджетный процессор AMD на архитектуре Zen 2', 7000, 65, 1, 'icons/cpu1'),
(10, 2, 'AMD Ryzen 5 5600X', 'AMD', 'Ryzen 5 5600X', '6-ядерный процессор с отличным соотношением цена/производительность', 16000, 65, 2, 'icons/cpu2'),
(11, 2, 'AMD Ryzen 7 5800X3D', 'AMD', 'Ryzen 7 5800X3D', 'Игровой процессор с технологией 3D V-Cache', 32000, 105, 3, 'icons/cpu3'),
(12, 2, 'AMD Ryzen 9 5950X', 'AMD', 'Ryzen 9 5950X', '16-ядерный процессор для рабочих станций', 48000, 105, 3, 'icons/cpu3'),
(13, 2, 'AMD Ryzen 5 7600', 'AMD', 'Ryzen 5 7600', 'Процессор нового поколения AM5 с DDR5', 21000, 65, 2, 'icons/cpu2'),
(14, 2, 'AMD Ryzen 7 7800X3D', 'AMD', 'Ryzen 7 7800X3D', 'Лучший игровой процессор на AM5', 38000, 120, 3, 'icons/cpu3'),
(15, 2, 'AMD Ryzen 9 7900X', 'AMD', 'Ryzen 9 7900X', '12-ядерный процессор для профессионалов', 52000, 170, 3, 'icons/cpu3'),
(16, 2, 'AMD Ryzen 5 7500F', 'AMD', 'Ryzen 5 7500F', 'Бюджетный процессор AM5 без встроенной графики', 14000, 65, 1, 'icons/cpu1');
...
-- ID 17-28
INSERT INTO components (id, category_id, name, vendor, model, description, price, power_watts, model_tier, icon_path) VALUES
(17, 6, 'ASUS PRIME H410M-K', 'ASUS', 'PRIME H410M-K', 'Базовая плата для офисных ПК', 6500, 40, 1, 'icons/mb1'),
(18, 6, 'MSI MAG B560M BAZOOKA', 'MSI', 'MAG B560M BAZOOKA', 'Средняя плата с поддержкой разгона памяти', 9500, 50, 2, 'icons/mb2'),
(19, 6, 'ASUS ROG STRIX Z590-A', 'ASUS', 'ROG STRIX Z590-A', 'Премиальная плата для разгона', 22000, 65, 3, 'icons/mb3'),
(20, 6, 'Gigabyte B760M DS3H', 'Gigabyte', 'B760M DS3H', 'Современная плата с DDR5', 11000, 50, 2, 'icons/mb2'),
(21, 6, 'MSI PRO Z790-P WIFI', 'MSI', 'PRO Z790-P WIFI', 'Флагманская плата с Wi-Fi', 24000, 65, 3, 'icons/mb3'),
(22, 6, 'ASRock H610M-HDV', 'ASRock', 'H610M-HDV', 'Бюджетная плата для LGA1700', 7000, 40, 1, 'icons/mb1'),
(23, 6, 'Gigabyte A520M S2H', 'Gigabyte', 'A520M S2H', 'Базовая плата AM4 для Ryzen', 5500, 40, 1, 'icons/mb1'),
(24, 6, 'MSI B550-A PRO', 'MSI', 'B550-A PRO', 'Надёжная ATX плата для игр', 12000, 55, 2, 'icons/mb2'),
(25, 6, 'ASUS ROG STRIX X570-E', 'ASUS', 'ROG STRIX X570-E', 'Топовая плата AM4 с PCIe 4.0', 28000, 70, 3, 'icons/mb3'),
(26, 6, 'ASRock B650M Pro RS', 'ASRock', 'B650M Pro RS', 'Средняя плата AM5 с DDR5', 14000, 55, 2, 'icons/mb2'),
(27, 6, 'MSI MAG X670E TOMAHAWK', 'MSI', 'MAG X670E TOMAHAWK', 'Мощная плата для Ryzen 7000', 32000, 70, 3, 'icons/mb3'),
(28, 6, 'Gigabyte A620M H', 'Gigabyte', 'A620M H', 'Бюджетная плата AM5', 8000, 40, 1, 'icons/mb1');
...
-- ID 29-40
INSERT INTO components (id, category_id, name, vendor, model, description, price, power_watts, model_tier, icon_path) VALUES
(29, 4, 'Kingston FURY Beast 16GB DDR4', 'Kingston', 'FURY Beast 16GB DDR4', 'Бюджетная DDR4 память', 4500, 0, 1, 'icons/ram1'),
(30, 4, 'Patriot Viper Steel 16GB DDR4', 'Patriot', 'Viper Steel 16GB DDR4', 'Надёжная память с радиаторами', 5500, 0, 2, 'icons/ram2'),
(31, 4, 'G.Skill Trident Z RGB 16GB DDR4', 'G.Skill', 'Trident Z RGB 16GB DDR4', 'Яркая RGB память для геймеров', 7000, 0, 2, 'icons/ram2'),
(32, 4, 'Corsair Vengeance LPX 32GB DDR4', 'Corsair', 'Vengeance LPX 32GB DDR4', '32 ГБ для тяжёлых задач', 9500, 0, 2, 'icons/ram2'),
(33, 4, 'G.Skill Trident Z Neo 32GB DDR4', 'G.Skill', 'Trident Z Neo 32GB DDR4', 'Высокоскоростная память для AMD', 13000, 0, 3, 'icons/ram3'),
(34, 4, 'Corsair Dominator Platinum 64GB DDR4', 'Corsair', 'Dominator Platinum 64GB DDR4', 'Премиальная память большого объёма', 22000, 0, 3, 'icons/ram3'),
(35, 4, 'Crucial Basics 16GB DDR5', 'Crucial', 'Basics 16GB DDR5', 'Базовая DDR5 память', 5500, 0, 1, 'icons/ram1'),
(36, 4, 'Kingston FURY Beast 32GB DDR5', 'Kingston', 'FURY Beast 32GB DDR5', 'Оптимальный набор DDR5', 10500, 0, 2, 'icons/ram2'),
(37, 4, 'G.Skill Trident Z5 RGB 32GB DDR5', 'G.Skill', 'Trident Z5 RGB 32GB DDR5', 'Высокоскоростная DDR5 с RGB', 14000, 0, 3, 'icons/ram3'),
(38, 4, 'Corsair Vengeance 64GB DDR5', 'Corsair', 'Vengeance 64GB DDR5', '64 ГБ для профессионалов', 21000, 0, 3, 'icons/ram3'),
(39, 4, 'ADATA XPG Lancer 16GB DDR5', 'ADATA', 'XPG Lancer 16GB DDR5', 'Бюджетный набор DDR5', 5000, 0, 1, 'icons/ram1'),
(40, 4, 'TeamGroup T-Force Delta 32GB DDR5', 'TeamGroup', 'T-Force Delta 32GB DDR5', 'Быстрая DDR5 с агрессивным дизайном', 15500, 0, 3, 'icons/ram3');
...
-- ID 41-52
INSERT INTO components (id, category_id, name, vendor, model, description, price, power_watts, model_tier, icon_path) VALUES
(41, 3, 'NVIDIA GeForce GTX 1650', 'NVIDIA', 'GeForce GTX 1650', 'Базовая видеокарта для нетребовательных игр', 14000, 75, 1, 'icons/gpu1'),
(42, 3, 'AMD Radeon RX 6500 XT', 'AMD', 'Radeon RX 6500 XT', 'Бюджетная видеокарта AMD', 13500, 107, 1, 'icons/gpu1'),
(43, 3, 'NVIDIA GeForce RTX 3050', 'NVIDIA', 'GeForce RTX 3050', 'Видеокарта с трассировкой лучей начального уровня', 23000, 130, 2, 'icons/gpu2'),
(44, 3, 'AMD Radeon RX 6600', 'AMD', 'Radeon RX 6600', 'Отличная карта для Full HD гейминга', 21000, 132, 2, 'icons/gpu2'),
(45, 3, 'NVIDIA GeForce RTX 3060 Ti', 'NVIDIA', 'GeForce RTX 3060 Ti', 'Золотая середина для 1440p', 32000, 200, 2, 'icons/gpu2'),
(46, 3, 'AMD Radeon RX 6700 XT', 'AMD', 'Radeon RX 6700 XT', '12 ГБ видеопамяти для высоких настроек', 38000, 230, 3, 'icons/gpu3'),
(47, 3, 'NVIDIA GeForce RTX 4070', 'NVIDIA', 'GeForce RTX 4070', 'Эффективная карта с DLSS 3', 55000, 200, 3, 'icons/gpu3'),
(48, 3, 'AMD Radeon RX 7800 XT', 'AMD', 'Radeon RX 7800 XT', '16 ГБ для 4K гейминга', 58000, 263, 3, 'icons/gpu3'),
(49, 3, 'NVIDIA GeForce RTX 4080', 'NVIDIA', 'GeForce RTX 4080', 'Мощная карта для 4K с запасом', 95000, 320, 3, 'icons/gpu3'),
(50, 3, 'AMD Radeon RX 7900 XTX', 'AMD', 'Radeon RX 7900 XTX', 'Флагман AMD с 24 ГБ видеопамяти', 105000, 355, 3, 'icons/gpu3'),
(51, 3, 'NVIDIA GeForce RTX 4060', 'NVIDIA', 'GeForce RTX 4060', 'Энергоэффективная карта с DLSS 3', 28000, 115, 2, 'icons/gpu2'),
(52, 3, 'Intel Arc A750', 'Intel', 'Arc A750', 'Видеокарта Intel с аппаратным RT', 25000, 225, 2, 'icons/gpu2');
...
-- ID 53-62
INSERT INTO components (id, category_id, name, vendor, model, description, price, power_watts, model_tier, icon_path) VALUES
(53, 5, 'Deepcool PF500', 'Deepcool', 'PF500', 'Бюджетный блок питания 500 Вт', 4000, 0, 1, 'icons/psu1'),
(54, 5, 'Cougar VTE500', 'Cougar', 'VTE500', 'Начальный БП с бронзовым сертификатом', 4500, 0, 1, 'icons/psu1'),
(55, 5, 'be quiet! System Power 10 650W', 'be quiet!', 'System Power 10 650W', 'Тихий и надёжный БП', 6500, 0, 2, 'icons/psu2'),
(56, 5, 'Cooler Master MWE 650 Bronze', 'Cooler Master', 'MWE 650 Bronze', 'Полумодульный БП для игровых сборок', 7000, 0, 2, 'icons/psu2'),
(57, 5, 'Corsair RM750e', 'Corsair', 'RM750e', 'Полностью модульный золотой БП', 10500, 0, 3, 'icons/psu3'),
(58, 5, 'Deepcool PQ850M', 'Deepcool', 'PQ850M', 'Мощный БП с золотым сертификатом', 12000, 0, 3, 'icons/psu3'),
(59, 5, 'Thermaltake Toughpower GF3 1000W', 'Thermaltake', 'Toughpower GF3 1000W', 'Килловатник с поддержкой ATX 3.0', 17000, 0, 3, 'icons/psu3'),
(60, 5, 'Seasonic FOCUS GX-850', 'Seasonic', 'FOCUS GX-850', 'Эталонный БП от Seasonic', 13500, 0, 3, 'icons/psu3'),
(61, 5, 'Gigabyte P550B', 'Gigabyte', 'P550B', 'Бюджетный БП 550 Вт', 4800, 0, 1, 'icons/psu1'),
(62, 5, 'ASUS ROG Thor 1200P', 'ASUS', 'ROG Thor 1200P', 'Премиальный платиновый БП с OLED-дисплеем', 32000, 0, 3, 'icons/psu3');
...
-- ID 63-72
INSERT INTO components (id, category_id, name, vendor, model, description, price, power_watts, model_tier, icon_path) VALUES
(63, 7, 'WD Blue 1TB HDD', 'Western Digital', 'Blue 1TB', 'Классический жёсткий диск на 1 ТБ', 4500, 0, 1, 'icons/storage1'),
(64, 7, 'Seagate Barracuda 2TB HDD', 'Seagate', 'Barracuda 2TB', '2 ТБ для хранения данных', 6000, 0, 1, 'icons/storage1'),
(65, 7, 'Kingston A400 480GB SSD', 'Kingston', 'A400 480GB', 'Бюджетный SATA SSD', 3500, 0, 1, 'icons/storage1'),
(66, 7, 'Samsung 870 EVO 1TB SSD', 'Samsung', '870 EVO 1TB', 'Надёжный SATA SSD на 1 ТБ', 8000, 0, 2, 'icons/storage2'),
(67, 7, 'WD Blue SN570 1TB NVMe', 'Western Digital', 'Blue SN570 1TB', 'Быстрый NVMe начального уровня', 7000, 0, 2, 'icons/storage2'),
(68, 7, 'Samsung 980 1TB NVMe', 'Samsung', '980 1TB', 'Популярный NVMe без DRAM', 8000, 0, 2, 'icons/storage2'),
(69, 7, 'Samsung 990 Pro 1TB NVMe', 'Samsung', '990 Pro 1TB', 'Самый быстрый PCIe 4.0 накопитель', 12000, 0, 3, 'icons/storage3'),
(70, 7, 'WD Black SN850X 2TB NVMe', 'Western Digital', 'Black SN850X 2TB', 'Топовый игровой NVMe 2 ТБ', 18500, 0, 3, 'icons/storage3'),
(71, 7, 'Kingston NV2 1TB NVMe', 'Kingston', 'NV2 1TB', 'Доступный NVMe PCIe 4.0', 6000, 0, 2, 'icons/storage2'),
(72, 7, 'Seagate FireCuda 530 2TB NVMe', 'Seagate', 'FireCuda 530 2TB', 'Высокоскоростной NVMe с большим ресурсом', 21000, 0, 3, 'icons/storage3');
...
-- ID 73-82
INSERT INTO components (id, category_id, name, vendor, model, description, price, power_watts, model_tier, icon_path) VALUES
(73, 8, 'Deepcool ICE BLADE 100', 'Deepcool', 'ICE BLADE 100', 'Простой бюджетный кулер', 1200, 0, 1, 'icons/cooler1'),
(74, 8, 'ID-COOLING SE-214-XT', 'ID-COOLING', 'SE-214-XT', 'Бюджетный кулер с хорошей эффективностью', 1800, 0, 1, 'icons/cooler1'),
(75, 8, 'Cooler Master Hyper 212', 'Cooler Master', 'Hyper 212', 'Народный кулер, проверенный временем', 3000, 0, 2, 'icons/cooler2'),
(76, 8, 'be quiet! Pure Rock 2', 'be quiet!', 'Pure Rock 2', 'Тихий кулер для средних процессоров', 3500, 0, 2, 'icons/cooler2'),
(77, 8, 'Deepcool AK400', 'Deepcool', 'AK400', 'Отличный кулер за свою цену', 2800, 0, 2, 'icons/cooler2'),
(78, 8, 'Noctua NH-D15', 'Noctua', 'NH-D15', 'Лучший воздушный кулер в мире', 9500, 0, 3, 'icons/cooler3'),
(79, 8, 'Arctic Liquid Freezer II 240', 'Arctic', 'Liquid Freezer II 240', 'СЖО с толстым радиатором', 8500, 0, 3, 'icons/cooler3'),
(80, 8, 'Corsair H100i Elite Capellix', 'Corsair', 'H100i Elite Capellix', 'Стильная СЖО с RGB подсветкой', 12500, 0, 3, 'icons/cooler3'),
(81, 8, 'Deepcool LS520', 'Deepcool', 'LS520', 'СЖО с яркой RGB помпой', 9500, 0, 3, 'icons/cooler3'),
(82, 8, 'NZXT Kraken X73', 'NZXT', 'Kraken X73', '360 мм СЖО с зеркальной помпой', 16000, 0, 3, 'icons/cooler3');
...
-- ID 83-94
INSERT INTO components (id, category_id, name, vendor, model, description, price, power_watts, model_tier, icon_path) VALUES
(83, 1, 'Zalman ZM-T3', 'Zalman', 'ZM-T3', 'Компактный бюджетный корпус mATX', 2500, 0, 1, 'icons/case1'),
(84, 1, 'Aerocool Cylon Mini', 'Aerocool', 'Cylon Mini', 'Минималистичный корпус с RGB полосой', 2200, 0, 1, 'icons/case1'),
(85, 1, 'Deepcool MATREXX 30', 'Deepcool', 'MATREXX 30', 'Бюджетный mATX с хорошей вентиляцией', 2000, 0, 1, 'icons/case1'),
(86, 1, 'Deepcool MATREXX 55 MESH', 'Deepcool', 'MATREXX 55 MESH', 'Просторный корпус с сетчатой передней панелью', 5500, 0, 2, 'icons/case2'),
(87, 1, 'Zalman Z9 NEO', 'Zalman', 'Z9 NEO', 'Стильный корпус с закалённым стеклом', 6000, 0, 2, 'icons/case2'),
(88, 1, 'Corsair 4000D Airflow', 'Corsair', '4000D Airflow', 'Легендарный корпус с отличным продувом', 9500, 0, 3, 'icons/case3'),
(89, 1, 'NZXT H510', 'NZXT', 'H510', 'Минималистичный корпус премиум-класса', 8500, 0, 3, 'icons/case3'),
(90, 1, 'Lian Li LANCOOL III', 'Lian Li', 'LANCOOL III', 'Просторный корпус с откидными панелями', 12000, 0, 3, 'icons/case3'),
(91, 1, 'Fractal Design Torrent', 'Fractal Design', 'Torrent', 'Лучший корпус по продуваемости', 17000, 0, 3, 'icons/case3'),
(92, 1, 'Phanteks Eclipse P300A', 'Phanteks', 'Eclipse P300A', 'Бюджетный корпус с mesh фасадом', 5200, 0, 2, 'icons/case2'),
(93, 1, 'Cooler Master MasterBox Q300L', 'Cooler Master', 'MasterBox Q300L', 'Универсальный mATX с магнитными фильтрами', 3800, 0, 1, 'icons/case1'),
(94, 1, 'be quiet! Pure Base 500DX', 'be quiet!', 'Pure Base 500DX', 'Тихий корпус с RGB и mesh', 10000, 0, 3, 'icons/case3');
